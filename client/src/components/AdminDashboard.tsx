  ...
  return (
    <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            ...
            {/* Kart 1: Kitap Çeşidi -> YENİ SAYFAYA GİDER */}
            <div 
                onClick={() => navigate("/admin-books")} 
                className="relative overflow-hidden bg-gradient-to-br from-purple-500 to-indigo-600 p-6 rounded-2xl shadow-lg text-white transform hover:scale-105 transition-all duration-300 group cursor-pointer"
            >
                <div className="flex justify-between items-start relative z-10">
                    <div>
                        ...
                        <p className="text-xs mt-2 bg-white/20 inline-block px-2 py-1 rounded backdrop-blur-sm">Listeyi Yönet →</p>
                    </div>
            ...
            {/* Kart 2: Toplam Stok -> YENİ SAYFAYA GİDER */}
            <div 
                onClick={() => navigate("/admin-books")} 
                className="relative overflow-hidden bg-gradient-to-br from-blue-500 to-cyan-500 p-6 rounded-2xl shadow-lg text-white transform hover:scale-105 transition-all duration-300 group cursor-pointer"
            >
                <div className="flex justify-between items-start relative z-10">
                    <div>
                        ...
                        <p className="text-xs mt-2 bg-white/20 inline-block px-2 py-1 rounded backdrop-blur-sm">Envanter →</p>
                    </div>
                    <div className="p-3 bg-white/20 rounded-xl backdrop-blur-md shadow-inner">
                        <Icons.Stock />
                    </div>
            ...
            {/* Kart 3: Şu An Okunan -> Ödünç Takip Sayfasına Gider */}
            <div 
                onClick={() => navigate("/admin-loans")} 
                className="relative overflow-hidden bg-gradient-to-br from-orange-500 to-red-500 p-6 rounded-2xl shadow-lg text-white transform hover:scale-105 transition-all duration-300 group cursor-pointer"
            >
                <div className="flex justify-between items-start relative z-10">
                    <div>
                        ...
                        <p className="text-xs mt-2 bg-white/20 inline-block px-2 py-1 rounded backdrop-blur-sm">Takip Et →</p>
                    </div>
                    <div className="p-3 bg-white/20 rounded-xl backdrop-blur-md shadow-inner">
                        <Icons.Loans />
                    </div>
            ...
            {/* Kart 4: Toplam Üye -> Kullanıcılar Sayfasına Gider */}
            <div 
                onClick={() => navigate("/users")} 
                className="relative overflow-hidden bg-gradient-to-br from-green-500 to-teal-500 p-6 rounded-2xl shadow-lg text-white transform hover:scale-105 transition-all duration-300 group cursor-pointer"
            >
                <div className="flex justify-between items-start relative z-10">
                    <div>
                        ...
                        <p className="text-xs mt-2 bg-white/20 inline-block px-2 py-1 rounded backdrop-blur-sm">Üyeleri Yönet →</p>
                    </div>
                    <div className="p-3 bg-white/20 rounded-xl backdrop-blur-md shadow-inner">
                        <Icons.Users />
                    </div>
